...
export default function AboutPage() {
  const skills = {
    languages: [
      { name: "JavaScript", icon: "/images/logo.png" },
      { name: "TypeScript", icon: "/images/logo.png" },
      { name: "Python", icon: "/images/logo.png" },
      { name: "Java", icon: "/images/logo.png" },
      { name: "SQL", icon: "/images/logo.png" },
      { name: "HTML", icon: "/images/logo.png" },
      { name: "CSS", icon: "/images/logo.png" },
    ],
    frameworks: [
      { name: "React", icon: "/images/logo.png" },
      { name: "NodeJS", icon: "/images/logo.png" },
      { name: "Next.js", icon: "/images/logo.png" },
      { name: "NestJS", icon: "/images/logo.png" },
      { name: "Express", icon: "/images/logo.png" },
      { name: "Spring Boot", icon: "/images/logo.png" },
      { name: "Prisma", icon: "/images/logo.png" },
      { name: "Tailwind CSS", icon: "/images/logo.png" },
      { name: "shadcn/ui", icon: "/images/logo.png" },
    ],
    tools: [
      { name: "Git", icon: "/images/logo.png" },
      { name: "GitHub Actions", icon: "/images/logo.png" },
      { name: "Docker", icon: "/images/logo.png" },
      { name: "Postman", icon: "/images/logo.png" },
      { name: "VS Code", icon: "/images/logo.png" },
      { name: "AWS S3", icon: "/images/logo.png" },
      { name: "Cloudinary", icon: "/images/logo.png" },
    ],
    databases: [
      { name: "MongoDB", icon: "/images/logo.png" },
      { name: "PostgreSQL", icon: "/images/logo.png" },
    ],
  };
